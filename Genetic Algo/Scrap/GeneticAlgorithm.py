...
class GeneticAlgorithm():
    ...
    def __setInitialPopulation(self, population= None):
        if population == None:
    ...
    def setPopulation(self, population = None):
        for indi in self.__setInitialPopulation(population=population):
            indi.fitness()
    ...
    def genChildren(self, population):
        gf = GeneticFunc()
        newGeneration = []
        ...
        for i in range(0, len(population)):
            ...
            newGeneration.append(new_c1)
            newGeneration.append(new_c2)
            print("################################")
...
if __name__ == "__main__":
    ...
    count = 0
    for i in range(10):
        new_population = ga.genChildren(population)
        print("*******************************************************************")
        population = ga.setPopulation(new_population)
        count += 1
